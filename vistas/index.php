...
<nav class="admin-nav">
    <div class="admin-nav-main">
        ...
        <div class="admin-nav-item admin-nav-message">
            Bienvenido <?php session_start(); echo(  $_SESSION["usuario"]["nombre"]) ?>
        </div>
...
if(isset($_POST["op"])){
    ...
    switch($vistaparcial){
        case 2:
            include("./eventospublicados.php");
        break;
        case 1:
            include("./gestioneventos.php");
        break;
        case 3:
            include("./agregaractividad.php");
        break;
        case 4:
            include("./agregarevento.php");
        break;
        case 7:
            include("./agregareventosconjun.php");
        break;
